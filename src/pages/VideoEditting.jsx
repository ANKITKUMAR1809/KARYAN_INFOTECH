  ...
  return (
    <>
      ...
      <section className="py-20 px-6 md:px-24 bg-gray-50">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800">
            हम क्या Use करते हैं? (What We Use)
          </h2>
          <p className="text-gray-600 mt-4">
            Industry-standard video editing tools और techniques से हम आपका
            content visually attractive बनाते हैं।
          </p>
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          >
            <CameraIcon className="text-orange-500 w-10 h-10 mx-auto mb-4" />
            <h4 className="font-semibold text-lg">Adobe Premiere Pro</h4>
            <p className="text-gray-600">Professional-grade editing के लिए।</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="bg-white p-6 rounded-lg shadow-md text-center"
          >
            <ScissorsIcon className="text-orange-500 w-10 h-10 mx-auto mb-4" />
            <h4 className="font-semibold text-lg">Final Cut Pro</h4>
            <p className="text-gray-600">
              High-quality smooth transitions और color correction।
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            ...
            className="bg-white p-6 rounded-lg shadow-md text-center"
          >
            <SparklesIcon className="text-orange-500 w-10 h-10 mx-auto mb-4" />
            <h4 className="font-semibold text-lg">After Effects</h4>
            <p className="text-gray-600">
              Motion graphics और animation के लिए।
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-24">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800">
            हम कैसे काम करते हैं? (How We Do)
          </h2>
          <p className="text-gray-600 mt-4">
            हम आपकी story और brand को highlight करने के लिए सबसे बेहतर shot
            selection, audio syncing, और cinematic techniques यूज़ करते हैं।
          </p>
        </motion.div>
        <div className="max-w-5xl mx-auto space-y-4 text-gray-700">
          <p>✔️ Script और footage analysis</p>
          <p>✔️ Video cut, transitions, music integration</p>
          <p>✔️ Revisions के बाद final render</p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-24 bg-gray-100">
        ...
        >
          ...
          <p className="text-gray-600 mt-4">
            Reels, YouTube videos, Ads, Explainers या Wedding highlights — हम हर
            format में excellence deliver करते हैं।
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-20 px-6 md:px-24">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800">
            बस एक कॉल और मैसेज की दूरी पर
          </h2>
          <p className="text-gray-600 mt-4">
            चलिए एक impactful वीडियो के साथ आपका brand बढ़ाते हैं। अभी संपर्क
            करें।
          </p>
          <div className="flex justify-center gap-6 mt-6 text-orange-500 text-xl">
            <a
              href="tel:+917091060239"
              className="flex items-center gap-2 hover:underline"
            >
              <PhoneCallIcon /> Call Us
            </a>
            <a
              href="mailto:infoaman@3karyaninfotech.in"
              className="flex items-center gap-2 hover:underline"
            >
